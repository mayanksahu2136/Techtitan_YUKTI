...
A full-stack application that analyzes social media profiles (Instagram, Facebook) to detect fake accounts, bots, and suspicious behavior patterns using ML and NLP analysis.
...
- **Detailed Breakdown**: View analysis of engagement, followers, posting patterns, bio consistency, and text analysis
